      ...
      rl.question('Type an option: ', (option) => {
        switch(option){
          case "1":
            ...
            break;
          case "2":
					db.collection('companies').count({}, {name: 1, _id: 0}).toArray((error, result) => {
						if (error) {
							console.log(error);
							rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
						} else {
            ...
            break;
						...
						break;
						case "4":
						db.collection('companies').find({"founded_year" : 2004, "founded_year" : 2}, {_id: 1}).count((error, result) => {
							if (error) {
								console.log(error);
								rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
							} else {
						...
						case "5":
						 ...
						 name: 1, founded_month: 1,founded_day: 1,_id: 0}).sort({ founded_month: 1, founded_day: 1,
